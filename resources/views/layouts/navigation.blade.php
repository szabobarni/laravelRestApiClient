    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="{{ asset('image/angled_view3.png') }}" alt="Melodex" class="h-9 w-auto"> 
                   </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @guest
                    <a href="/login" class="text-gray-600 dark:text-gray-300 px-4">Log In</a>
                    <a href="/register" class="text-gray-600 dark:text-gray-300 px-4">Register</a>
                @endguest
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        @guest
            <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600 px-4">
                <a href="/login" class="block text-gray-700 dark:text-gray-300">Log In</a>
                <a href="/register" class="block text-gray-700 dark:text-gray-300 mt-2">Register</a>
            </div>
        @endguest
